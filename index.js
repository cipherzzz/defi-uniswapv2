...
const init = async ()=>{
    ...
    const trade = new Trade(route, new TokenAmount(weth, parseUnits(amountInEth), 18), TradeType.EXACT_INPUT);
    ...
    const tx = await uniswap.swapExactETHForTokens(amountOutMin, path, address, deadline, { value: value, gasLimit: process.env.GAS_LIMIT });
